"""Roost assumptions and constants"""
from typing import Final

# Down payment model
DEFAULT_TARGET_HOME_PRICE_CAD: Final[float] = 1_316_700.0
DEFAULT_TARGET_HOME_DOWNPAYMENT_CAD: Final[float] = 156_670.0
DOWN_PAYMENT_PCT: Final[float] = DEFAULT_TARGET_HOME_DOWNPAYMENT_CAD / DEFAULT_TARGET_HOME_PRICE_CAD  

# Victoria / Greater Victoria context (CMHC / local data)
...
OPTIMISTIC_RENT_GROWTH: Final[float] = 0.0  
PESSIMISTIC_RENT_GROWTH: Final[float] = 0.05  
...
INCOME_NEEDED_TO_QUALIFY_CAD: Final[float] = 200_000.0 
LISTINGS_CACHE_TTL: Final[int] = 3600  
